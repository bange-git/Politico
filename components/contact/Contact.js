...
import { FlexContact, InputField, Form, FormGroup, FormCard, Label, TextArea, SubmitButton, FlexRow } from './contact.style';
  ...
  { userList.map((user, index) =>{
   ...
   <FormCard>
    <FormGroup>
     ...
     posts.length > 0 && (
      <>
        <h3>{posts[0].title} {posts[0].id}</h3>
        <p>{posts[0].body}</p>
        <p><button>Edit</button> | <span><button
        onClick={() => {
